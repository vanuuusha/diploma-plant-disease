...
По итогам task_15 и task_16 установлено, что CGFM P3+P4+P5 с идентичной-старт инициализацией FiLM функционально тождественна baseline из-за **identity-collapse** (γ ≈ 1, β = 0 + BN-поглощение остаточных возмущений). Лучшая рабочая конфигурация — **P5-only** (task_16, mAP@50 = 0.650, **+2.7 п.п.** к baseline 0.623). Это стало мотивацией для дополнительного исследования (task_19): можно ли пробить identity-collapse и получить работающий CGFM на всех 3 уровнях FPN?
...
Обе вариации дали результат 0.622–0.628, близкий к baseline (0.623) и базовой P3+P4+P5-конфигурации. Improve над P5-only (0.650) не удалось. Причины:
