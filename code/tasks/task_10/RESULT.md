...
|---|---:|---:|---:|---:|---:|---:|---:|
| baseline | 3 109 | **0.337** | 0.177 | 0.210 | 0.495 | 64.0 | 100 |
| aug_geom | 9 323 | 0.328 | 0.162 | 0.146 | 0.541 | 58.5 | 76 |
| aug_oversample | 10 405 | 0.336 | 0.174 | 0.184 | 0.512 | 61.1 | 96 |
| aug_diffusion | 10 855 | 0.316 | 0.156 | 0.124 | 0.541 | 57.9 | 61 |
...
2. **Diffusion-синтетика** имеет артефакты генерации (особенно на фоне), которые DETR воспринимает как ложные объекты. `Precision=0.124` на aug_diffusion — самый низкий у всех детекторов.
...
- **Низкий Precision (0.12–0.21)** — системная особенность DETR из-за избыточных num_queries=100. В настоящем production стоило бы снизить до 30.
