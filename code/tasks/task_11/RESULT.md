...
| yolov12 | aug_oversample | 0.645 | 0.358 | 19.36 | 34 |
| yolov12 | aug_diffusion | **0.651** | **0.365** | 20.36 | 98 |
| rtdetr | baseline | 0.611 | 0.369 | — | 25 |
| rtdetr | aug_geom | 0.630 | 0.347 | 19.38 | 26 |
| rtdetr | aug_oversample | 0.632 | 0.350 | 20.78 | 27 |
| rtdetr | aug_diffusion | **0.635** | **0.353** | 17.99 | 28 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| **YOLOv12** ← лидер | aug_diffusion | **0.651** | 0.365 | 0.820 | 0.700 | 20.36 | 20.1 |
...
- **YOLOv12 aug_diffusion**: mAP@50 = 0.651, 95% CI [0.593, 0.709]
- **RT-DETR aug_diffusion**: mAP@50 = 0.635, 95% CI [0.575, 0.695]
...
- **YOLOv12 — лидер** главы 3 (mAP@50 = 0.651 на aug_diffusion, выше RT-DETR 0.635 во всех 4 вариантах).
...
- aug_diffusion — финальная стадия аугментации по протоколу, охватывает наибольший test-срез и даёт наилучшие метрики по всем показателям.

### Выводы по стадиям аугментации

| Паттерн | Наблюдение |
|---|---|
| YOLOv12 | Основной прирост на aug_geom (+2.3 п.п.), далее стабильный прирост +0.5–0.7 на каждой последующей стадии |
| RT-DETR | Прирост сглажен (+1.9 п.п. на aug_geom, +0.2–0.3 на последующих стадиях) — встроенный attention дает часть того же эффекта |
